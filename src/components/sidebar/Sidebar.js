...
export default class Sidebar extends Component {
  ...
  render() {
    ...
    return (
        <aside id="sidebar">
            <div id="sidebar">
                <form onSubmit={e => e.preventDefault()} action="#" className="search-hotel">
                    ...
                    <Slider id={'id-1'} handle={handle} min={min} max={max} value={this.state.value} onChange={(e) => this.setValue(e)} onAfterChange={() => this.props.findHotelByName('price', this.state.value)} />
                </form>
            </div>
        </aside>
    );
